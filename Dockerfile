...
ENV PURESCRIPT_DOWNLOAD_SHA1 112e77bd9e5b99cfe92790c6d8b3832a47340738

RUN npm install -g bower pulp

RUN cd /opt \
    && wget https://github.com/purescript/purescript/releases/download/v0.11.4/linux64.tar.gz \
