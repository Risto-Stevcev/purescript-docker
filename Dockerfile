...
ENV PURESCRIPT_DOWNLOAD_SHA1 569238368864ecbc89d4800503c7e500a11dc431

RUN npm install -g bower pulp

RUN cd /opt \
    && wget https://github.com/purescript/purescript/releases/download/v0.10.6/linux64.tar.gz \
