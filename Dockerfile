...
ENV PURESCRIPT_DOWNLOAD_SHA1 be05b610b6bc43e6cb93238ffb49696cf37b0fb3

RUN npm install -g bower pulp@9.0.1

RUN cd /opt \
    && wget https://github.com/purescript/purescript/releases/download/v0.10.1/linux64.tar.gz \
